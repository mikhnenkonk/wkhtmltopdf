...
static const char qt_meta_stringdata_wkhtmltopdf__ConverterPrivate[] = {
    ...
    "cancel()\0convert()\0bool\0forwardError(QString)\0"
...
void wkhtmltopdf::ConverterPrivate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: { bool _r = _t->convert();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 5: _t->forwardError((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 6: _t->forwardWarning((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
